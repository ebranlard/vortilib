function [ax1,ax2,ax3,ax4,i1,i2,i3,i4]=interp_coeff_lambda3(i2,dx2,nx)
    if nargin==0
        % TEST
        [ax1,ax2,ax3,ax4,i1,i2,i3,i4]=interp_coeff_lambda3(3,0.1,5)
        return
    end
    % !---------------------------------------------------------------------------
    ...
    % ! The lambda 3 kernel
    % !---------------------------------------------------------------------------
    ax1 = 1./6.*(1.0-dx1)*(2.0-dx1)*(3.-dx1);
    ax2 = 1./2.*(1-dx2^2)*(2-dx2);
    ax3 = 1./2.*(1-dx3^2)*(2-dx3);
    ax4 = 1./6.*(1.0-dx4)*(2.0-dx4)*(3.-dx4);
